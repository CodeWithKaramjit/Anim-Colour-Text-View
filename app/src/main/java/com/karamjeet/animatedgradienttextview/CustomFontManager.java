package com.karamjeet.animatedgradienttextview;
...
public final class CustomFontManager {
    ...
    public static void applyFontFromAttrs(TextView textView, AttributeSet attrs) {
        ...
        @SuppressLint("ResourceType") final TypedArray typedArray = textView.getContext().obtainStyledAttributes(attrs, set);
